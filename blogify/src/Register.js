...
class Register extends React.Component{
  ...
  render(){
    ...
    return(
      <div>
       <main className="pa0 black-100">
       <article className="br5 ba dark-gray shadow-5 b--black-10 mv4 w-100 w-50-m w-25-l mw6 center">
 <form className="measure center">
   <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
     <legend className="f4 pa2 fw6 ph0 mh0">Register</legend>
     <div className="mt3">
       <label className="db fw6 lh-copy f6" htmlFor="name">Name</label>
       <input
       onChange={this.onNameChange}
       className="pa2 input-reset ba hover-bg-black hover-white w-90" type="name" name="name"  id="name"/>
     </div>
     <div className="mt3">
   ...
   <div className="">
     ...
     className="b  ph3 pv2 w-75  input-reset ba b--black grow pointer f6 dib" type="submit" value="Register"/>
   </div>
